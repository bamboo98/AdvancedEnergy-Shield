...
namespace zhuzi.AdvancedEnergy.Shields.Shields
{
    ...
    public class Comp_ShieldGenerator : ThingComp
    {
        ...
        private bool zzShieldDefenceProjectileActive = true;
        private bool zzShieldDefenceSkyActive = true;
        private bool zzShieldDefenceIFFActive = true;
        ...
        {
            zzShieldWarmupTicks = 0;
            ShieldEnergyCurrent = ShieldEnergyMax;
            UpdateShieldStatus();
        }
        ...
        private static readonly List<int> quene = new List<int> { -99 };
        private static readonly float FadeTime = 3.65f;
        private static readonly int FadeTick = FadeTime.SecondsToTicks();
        private static readonly int MaxCountOnScreen = 10;


        public static bool CanAddMote()
        {
            int gt = GenTicks.TicksGame;
            if (quene.Count >= MaxCountOnScreen)
                quene.RemoveAll((x) => { return x + FadeTick < gt; });
            else
                return true;
            if (quene.Count >= MaxCountOnScreen)
                return false;
        ...
        public void FlickShieldDefenceIFF()
        {
            zzShieldDefenceIFFActive = !zzShieldDefenceIFFActive;
        }
